  ...
  return (
    <AdminModal open={open} onClose={onClose} title={event ? "Edit Event" : "Create Event"}>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-sm text-foreground mb-1.5">Event Name *</label>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm text-foreground mb-1.5">Max Guests</label>
        ...
        <div>
          <label className="block text-sm text-foreground mb-1.5">Description</label>
